...
RSpec.describe Cassia::ResponseHandlers::DiscoverAllChar do
  include FaradayHelpers
  describe "#handle" do
    vcr_options = { cassette_name: 'ResHdlr_discover_all_char/success', record: :new_episodes }
    ...
    vcr_options = { cassette_name: 'ResHdlr_discover_all_char/failure', record: :new_episodes }
      context "when passing in a valid router and device_mac", vcr: vcr_options do
