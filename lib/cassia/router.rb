module Cassia
  class Router
    ...
    def discover_char_one_service(access_controller, device_mac: , service_uuid: )
      Cassia::Requests::DiscoverCharOneService.new(access_controller, router: self, device_mac: device_mac, service_uuid: service_uuid).perform
    end
  end
end
